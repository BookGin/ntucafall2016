...
* Teamwork:
  + module
    - 林書瑾: branch instructions (beq, jmp), pipeline datapath debugging
    - 吳家謙: memory instructions (lw, sw), pipeline registers, pipeline datapath debugging
    - 張庭瑋: Hazzard Detection, Forwarding, pipeline datapath debugging
  + combination   
    - All members: CPU
  + debugging    
    - All members: See below
  + release
